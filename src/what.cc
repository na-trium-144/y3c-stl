...
const char *ub_iter_after_end() { return "iterated over the end() of container."; }
const char *ub_iter_before_begin() { return "iterated back beyond the begin() of container."; }
} // namespace what
