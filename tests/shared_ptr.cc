...
TEST(y3c, shared_ptr) {
...

    {
        ...
        EXPECT_TRUE(static_cast<bool>(static_cast<std::shared_ptr<A>>(a)));
        ...
        EXPECT_FALSE(static_cast<bool>(static_cast<std::shared_ptr<A>>(a)));
    }
    {
        ...
        EXPECT_TRUE(static_cast<bool>(static_cast<std::shared_ptr<A>>(a2)));
        ...
        EXPECT_THROW(static_cast<std::shared_ptr<A>>(a2),
                     y3c::internal::exception_terminate);
    }
}
